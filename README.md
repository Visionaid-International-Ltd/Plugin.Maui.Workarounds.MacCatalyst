# Plugin.Maui.Workarounds.MacCatalyst Template

The `Plugin.Maui.Workarounds.MacCatalyst` repository is a template repository that can be used to bootstrap your own .NET MAUI plugin project. You can use this project structure as a blueprint for your own work.
...
8. Make super sure that your package won't show up as `Plugin.Maui.Workarounds.MacCatalyst` on NuGet! If one does, you owe me a drink!
